...
public sealed class AuthHelpersTests
{
    ...
    [InlineData("PUT", "/api/media/object-upload/xiaolou-staging/media/frontend/sample.png", false)]
    ...
    [InlineData("/api/media/object-upload/xiaolou-staging/media/frontend/sample.png", false)]
    ...
    [InlineData("PUT", "/api/media/object-upload/xiaolou-staging/media/frontend/sample.png", null)]
