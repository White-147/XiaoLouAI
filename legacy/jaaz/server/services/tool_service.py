...
from services.xiaolou_adapter import register_xiaolou_tools
...
class ToolService:
    ...
    async def initialize(self):
        ...
        try:
            ...
            if config_service.app_config.get("xiaolou", {}).get("url", ""):
                await register_xiaolou_tools(self.register_tool)
