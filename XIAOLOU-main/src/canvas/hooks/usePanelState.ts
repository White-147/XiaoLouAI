...
export const usePanelState = () => {
     ...
     */
    const handleHistoryClick = useCallback((_e: React.MouseEvent, closeWorkflowPanel: () => void) => {
     ...
     */
    const handleAssetsClick = useCallback((_e: React.MouseEvent, closeWorkflowPanel: () => void) => {
     ...
     */
    const openAssetLibraryModal = useCallback((_y: number, closeWorkflowPanel: () => void) => {
