...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  showHistory = true,
  showAssets = true,
  allowTikTokImport = true,
  allowStoryboard = true,
}) => {
  const [isToolsOpen, setIsToolsOpen] = useState(false);
  const toolsRef = useRef<HTMLDivElement>(null);
  const hasToolsMenu = allowTikTokImport || allowStoryboard;
                ...
                {allowTikTokImport && (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className={`text-xs ${isDark ? 'text-neutral-500' : 'text-neutral-400'}`}>无水印下载</p>
                    </div>
                  </button>
                )}
                ...
                {allowStoryboard && (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className={`text-xs ${isDark ? 'text-neutral-500' : 'text-neutral-400'}`}>AI 创建场景</p>
                    </div>
                  </button>
                )}
              </div>
