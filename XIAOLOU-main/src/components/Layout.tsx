...
import CanvasCreate from "../pages/create/CanvasCreate";
...
const navItems: NavItem[] = [
  { name: "首页", path: "/home", icon: LayoutDashboard },
  {
    ...
    icon: FlaskConical,
    children: [
      { name: "新对话", path: "/playground", icon: MessageSquarePlus },
      { name: "对话记录", path: "/playground/chats", icon: MessagesSquare },
      { name: "笔记", path: "/playground/notes", icon: StickyNote },
    ],
  },
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm">
            ...
            >
              <div className="mb-6 flex items-center justify-between gap-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground">身份切换与账号入口</h3>
                  ...
                  {recentActors.length ? (
                    <div className="mt-6">
                      <div className="mb-3 flex items-center justify-between gap-3">
                        <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">最近账号 · 快速切换</p>
      ...
      <main className="relative flex h-full flex-1 flex-col overflow-hidden bg-background">
        {!isCanvasRoute && !isPlaygroundRoute ? <Outlet /> : null}
        ...
        {hasMountedPlayground ? (
          ...
          >
            <Playground visible={isPlaygroundRoute} />
          </div>
        ) : null}
      </main>
