            ...
            <div className="bg-[#121212] border border-neutral-800 rounded-2xl w-[600px] shadow-2xl overflow-hidden flex flex-col">
                ...
                <div className="px-6 pt-6 pb-2">
                    <div className="flex items-center gap-6 border-b border-neutral-700 pb-2">
                        <button className="text-white font-medium border-b-2 border-white pb-2 -mb-2.5">保存到素材库</button>
                        <button className="text-neutral-500 font-medium pb-2 hover:text-neutral-300 transition-colors">添加到现有素材</button>
                    </div>
                </div>
